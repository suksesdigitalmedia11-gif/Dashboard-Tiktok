...
async function upsertAdSpendRows(rows) {
  ...
  // SQLite: upsert by (store_name, spend_date, transaction_id) when transaction_id exists,
  // fallback to (store_name, spend_date, channel, campaign) for legacy rows without txId
